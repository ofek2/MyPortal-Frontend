...
function RegisteredUserSection(props: RegisteredUserSectionProps) {
	const BlockedUserSection = () => <>
		...
		<> 
			...
			<LoadingButton variant="contained" color="primary" onClick={props.onUnlockUser} isLoading={!!props.isLoadingUnlock} className="idf-button">לחץ\י כאן לשחרור החסימה</LoadingButton>
	...
	const ResetPasswordSection = () => <>
		...
		<LoadingButton variant="contained" color="primary" onClick={props.onResetPassword} isLoading={!!props.isLoadingResetPassword} className="idf-button">לחץ\י כאן לאיפוס הסיסמה</LoadingButton>
