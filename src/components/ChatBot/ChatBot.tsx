		...
		const questions = [
			{
				...
				answer:
					`מספר הטלפון שברשותך אינו מעודכן ברישומת הצה"לית ויש לעדכנו. <br>
					...
					גמלאים - יש לעדכן את פרטי ההתקשרות מול מוקד מופת.<br>
					מילואים - יש לעדכן את פרטי הקשר אצל קצין/ת הקישור.<br>
